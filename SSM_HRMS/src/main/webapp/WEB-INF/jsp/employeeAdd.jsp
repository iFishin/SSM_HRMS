            ...
            <div class="modal-body">
                <form class="form-horizontal add_emp_form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="empName" class="form-control" id="add_inputName" placeholder="鱼    ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="email" name="empEmail" class="form-control" id="add_inputEmail" placeholder="2079797279@qq.com">
