            ...
            <div class="modal-body">
                <form class="form-horizontal add_dept_form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="deptName" class="form-control" id="add_deptName" placeholder="技术部">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add_deptLeader" class="col-sm-2 control-label">部门老大</label>
                        <div class="col-sm-8">
                            <input type="text" name="deptLeader" class="form-control" id="add_deptLeader" placeholder="Fish">
                        </div>
                    </div>
                </form>
            </div>
